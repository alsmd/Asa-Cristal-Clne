                ...
                <div class="col-md-8">
                   <div class="d-flex">
                        ...
                        <div class="d-flex flex-column ml-3">
                            <h3 class="m-0 d-inline jogo-titulo"><a href="" class="text-warning">Asa de Cristal</a><small class="d-none d-lg-inline ml-1">(Hoje: <span class="text-warning">26</span>)</small></h3> 
                            <p class="lead m-0 jogo-conteudo">O melhor MMORPG da Gamesow !!</p>
                            <div class="dropdown">
