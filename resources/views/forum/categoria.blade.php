...
<body class="bg-dark" >
    ...
    <div class="container text-info">
        <a href=""class="text-info">FÓRUM</a> » <a href="/forum" class="text-info">Página inicial</a href="/forum"> »<a href="/forum/{{$slug_jogo}}"class="text-info"> Jogo</a> <span class="text-info">» Categoria</span>
    </div>
                ...
                <div class="col-md-8">
                   <div class="d-flex">
                        ...
                        <div class="d-flex flex-column ml-3">
                            <h3 class="m-0 d-inline jogo-titulo"><a href="/forum/{{$slug_jogo}}/{{$slug_categoria}}" class="text-warning">{{$postagem->nome}}</a></h3> 
